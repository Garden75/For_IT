...
<div class="main-content">
	...
	<div class="container pt-70 pb-20">
		...
		<div class="section-content">
			<div class="row">
				<div class="col-md-12">
					<h2 class="title text-white">동아리 소개</h2>
		...
		<div class="row col-md-10 blog-pull-right">
			<div class="col-md-12 ">
				<h3
					...
					소개 및 조직도<span class="text-theme-color-2 font-weight-400">
						introduce</span>
				</h3>
				<div class="border-1px p-30 mb-0 mt-10">

					<div class="section-content">
						<div class="row">
							<div class="col-md-6">
								<h6
									class="letter-space-4 text-gray-darkgray text-uppercase mt-0 mb-0"></h6>
								<h2 class="text-uppercase font-weight-600 font-28 text-center">
									자바 동아리&nbsp;&nbsp;&nbsp;</h2>
								<h4 class="text-theme-colored mt-30">
									<b>Global IT business "DBDB X DEEP"</b>
								</h4>
