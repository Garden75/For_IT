...
<div class="main-content">
   <!-- Section: inner-header       /adminNotice?command=adminNoticeList -->
   <section
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <ol class="breadcrumb text-left text-white">
                     <!-- <li><a href="/adminNotice?command=adminNoticeList">&nbsp;</a></li> -->
                  </ol>
               </div>
            </div>
         </div>
               ...
               <div class="col-md-12 mt-10">
                  ...
                  <div id="accordion1" class="panel-group accordion">
                     ...
                     <div data-example-id="striped-table"
                        class="bs-example notice-head-table">
                        <table class="table table-striped notice-table table-no-margin">
                           <thead>
                              <tr>
                                 ...
                                 <th class="col-sm-2"><span><i
                                       class="fas fa-clock" title="등록일"></i></span>등록일</th>
                     ...
                     <c:forEach items="${topList}" var="noticeVO" varStatus="status">
                        <div class="panel panel-primary">
                           <div class="panel-title">
                              <a data-parent="#accordion${status.count}"
                                 id="boardNum${status.count}" data-toggle="collapse"
                                 href="#accordion${status.count + 10}"
                                 class="<c:choose>
                                 ...
                                 style="background: lightblue"> <input type="hidden"
                                 name="noNum" value="${noticeVO.noNum}"> <span
                                 class="open-sub"></span> <strong>
                                    <table
                           ...
                           <div id="accordion${status.count + 10}"
                              ...
                              <div class="panel-content">
                                 ...
                                 <div class="blog-pull-right">
                                    <dt>
                                       <ul class="attachFiles"></ul>
                                    </dt>
                                 </div>

                                 <%-- 내용 --%>
                                 <div class="panel-body content-box">${noticeVO.noText}</div>
                                 <%-- 링크 --%>
                                 <div class="panel-heading">링크</div>
                                 <div class="panel-body">
                                    <div class="imgAttachment">
                                       <ul
                                          class="mailbox-attachments clearfix showImgUploadedList"></ul>
                                    </div>
                                 </div>
                     ...
                     <c:forEach items="${list}" var="noticeVO" varStatus="status">
                        <div class="panel">
                           <div class="panel-title">
                              <a data-parent="#accordion${status.count + 3}"
                                 id="boardNum${status.count + 3}" data-toggle="collapse"
                        ...
                        <ul class="pagination theme-colored xs-pull-center mb-xs-40">
                           ...
                           <c:forEach begin="${pageMaker.startPage }"
                              ...
                              <li
                                 <c:out value="${pageMaker.cri.page == idx?'class =active':''}" />>
                                 <a
                                 href="list${pageMaker.makeSearch(idx)}&categorize=${cri.categorize}&compnums=${cri.compnums}">${idx}</a>
                              </li>
                           </c:forEach>
            ...
            <div class="sidebar sidebar-left mt-sm-30">
               <div class="widget">
                  <h5 class="widget-title line-bottom">
                     <a href="introGroup">커뮤니티</a>
                  </h5>
                  <div class="categories">
                     <ul class="list list-border angle-double-right">
                        <li><a href="/notice/list">공지사항 </a></li>
                        <li><a href="/imgGallery/list">오늘의 과제</a></li>
...
<script>
               ...
               function() {
                  $("#listType")
                        .on(
                              "change",
                              function(evnet) {
                                 location.href = "/notice/list?page=${cri.page}&perPageNum=${cri.perPageNum}&searchType=${cri.searchType}&keyword=${cri.keyword}&listType="
                                       + this.value;
                              });
   ...
   var imgUploadedAttachment = Handlebars.compile($("#imgUploadedAttachment")
         .html());
   ...
   $(".panel-title > a").on(
         ...
         function(event) {
            ...
            if (isExpanded == 'false') {
               var noNum = $("#" + boardNum + "> input[name=noNum]").attr(
                     "value");
               $.ajax({
                  url : "/notice/read",
                  type : "post",
